...
### 3.3 ブランドパレット — Cobalt Ink + Mint（確定 2026-06-20）

> ✅ **確定**: ほぼモノクロのコバルトグレー neutrals ＋ 電撃コバルトの主アクセント ＋
> ライトミントの第2アクセント。旧 Notion teal-blue（`#2eaadc`）は退役。
...
- **accent はダークで明度を上げる**（`#1f4fff` → dark `#5b82ff`）。明るくした分、**dark の on-accent は near-black に切替**（白だとコントラスト不足）。
