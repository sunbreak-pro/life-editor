...
function makeTimerValue(
  ...
  return {
    ...
    setWorkDurationMinutes: vi.fn(),
    setBreakDurationMinutes: vi.fn(),
    setLongBreakDurationMinutes: vi.fn(),
    setSessionsBeforeLongBreak: vi.fn(),
    setAutoStartBreaks: vi.fn(),
    setTargetSessions: vi.fn(),
    createPresetFromCurrent: vi.fn(async () => {}),
    applyPreset: vi.fn(),
