...
/*
 * Pomodoro timer face (W3-B). Pure design-system primitive — ink-* tokens
...
// calmer success tone. All ink-* tokens (no hardcoded colour, §6.4).
const PHASE_RING: Record<PomodoroPhase, string> = {
  WORK: "text-ink-accent",
  BREAK: "text-ink-success",
  LONG_BREAK: "text-ink-success",
};
    ...
    <Card padding="lg" className="flex flex-col items-center gap-5">
      ...
      <div className="relative grid place-items-center">
        ...
        <div className="absolute flex flex-col items-center">
          <span
            className="font-mono text-4xl font-semibold tabular-nums text-ink-text"
            aria-live="polite"
          >
            {formatted}
          </span>
          <span className="mt-1 text-xs text-ink-text-secondary">
