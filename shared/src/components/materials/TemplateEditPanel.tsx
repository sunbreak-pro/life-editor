 ...
 * heading, the body under it, the same card insets — and everything the note
...
export function TemplateEditPanel({
  ...
  return (
    ...
    <Modal open={open} onClose={onCancel} title={labels.panelTitle} size="lg">
      <div className="flex flex-col gap-4">
        <input
          ...
          className={cn(
            ...
            "min-w-0 border-none bg-transparent px-0 py-0.5 text-[28px] [--field-font-size:28px] font-bold leading-tight tracking-tight text-lumen-text placeholder:text-lumen-text-tertiary",
            FOCUS_RING,
          )}
        />

        <div className="flex min-w-0 flex-col gap-1 [&_.note-editor]:min-h-[320px]">
          {bodyEditor}
        </div>
