  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="kanban-modal-panel relative flex max-h-[88vh] w-full max-w-[820px] flex-col overflow-hidden rounded-2xl border border-lumen-border bg-lumen-bg shadow-lumen-lg"
      >
        ...
        <div className="flex items-center gap-3.5 border-b border-lumen-border px-6 py-3.5">
          <div className="flex min-w-0 flex-1 items-center gap-1.5 text-[0.8125rem] text-lumen-text-secondary">
            {folderName && (
              <>
                <span
                  aria-hidden
                  className={cn(
                    ...
                    folderColor ? "" : "bg-lumen-border-strong",
                  )}
                  style={
            ...
            <span
              ...
              className="font-semibold text-lumen-text"
            >
              {breadcrumbTaskLabel}
            </span>
          </div>
          <button
            ...
            title={closeLabel}
            className={cn(
              "grid h-9 w-9 shrink-0 place-items-center rounded-md border border-lumen-border",
              "text-lumen-text-secondary transition-colors hover:bg-lumen-hover hover:text-lumen-text",
