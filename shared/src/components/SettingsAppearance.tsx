 ...
 * via `labels`. lumen-* tokens only, no hardcoded colors (CLAUDE.md §6.4).
 */
    ...
    <div className="space-y-6" data-section-id="appearance">
      ...
      <div className="py-3">
        ...
        <input
          ...
          className="w-full accent-[var(--color-lumen-accent)]"
        />
        <div className="mt-1 flex justify-between text-xs text-lumen-text-secondary">
