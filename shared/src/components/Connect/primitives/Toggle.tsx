    ...
    <button
      ...
      className={
        ...
        (value
          ...
          : "border-transparent hover:bg-notion-hover")
      }
    >
      <span
        className={
          "flex items-center gap-2 text-[12px] " +
          (value ? "text-notion-text" : "text-notion-text-secondary")
        }
      >
        {Icon && <Icon size={13} />}
        {label}
      ...
      <span
        className={
          ...
          (value ? "bg-notion-accent" : "bg-notion-border")
        }
      >
        <span
          className="absolute top-0.5 w-3 h-3 rounded-full bg-notion-bg transition-all"
