...
// ---------------------------------------------------------------------------
// LEGACY (Phase 2 / 0006 — DU-C-4 service rewrite removes after switching)
// ---------------------------------------------------------------------------

/**
 * @deprecated Use `RoutineGroupAssignmentRowV2`. Phase 2 0006 column
 * shape (routine_id, no rename; with created_at).
 */
