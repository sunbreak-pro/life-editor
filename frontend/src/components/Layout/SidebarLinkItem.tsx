    ...
    <div ref={wrapperRef} className="group relative">
      ...
      >
        ...
        <button
          ...
          className={`shrink-0 p-0.5 rounded hover:bg-notion-hover transition-opacity ${
      ...
      {menuOpen && (
        <div className="absolute right-1 top-full mt-1 z-30 w-32 bg-notion-bg-popover border border-notion-border rounded-md shadow-lg py-1">
          <button
            type="button"
