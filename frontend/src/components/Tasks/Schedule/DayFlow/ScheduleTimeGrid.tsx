...
export function ScheduleTimeGrid({
  ...
  const groupFrames = useMemo(
    () =>
      computeGroupFrames(unifiedItems, routineGroups, groupForRoutine, dateKey),
    [unifiedItems, routineGroups, groupForRoutine, dateKey],
  );

  const hasRoutineTaskSplit = useMemo(
    () => detectRoutineTaskSplit(unifiedItems, groupFrames),
