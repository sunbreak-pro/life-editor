...
export function useScheduleItems(): ScheduleItemsContextValue {
  ...
  return useMemo(
    () => ({
      ...
      softDeleteScheduleItem: core.softDeleteScheduleItem,
      removeScheduleItemsByIds: core.removeScheduleItemsByIds,
      deletedScheduleItems: core.deletedScheduleItems,
      loadDeletedScheduleItems: core.loadDeletedScheduleItems,
      restoreScheduleItem: core.restoreScheduleItem,
      permanentDeleteScheduleItem: core.permanentDeleteScheduleItem,
    ...
    [
      ...
      core.softDeleteScheduleItem,
      core.removeScheduleItemsByIds,
      core.deletedScheduleItems,
      core.loadDeletedScheduleItems,
      core.restoreScheduleItem,
      core.permanentDeleteScheduleItem,
