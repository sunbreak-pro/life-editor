 ...
 *   - Opaque `ink-bg-secondary` surface with a `ink-danger` bottom
 ...
 *     (border + text-ink-danger) rather than introducing an undefined
...
export function OfflineBanner(): React.JSX.Element | null {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="flex w-full items-center justify-center gap-2 border-b border-ink-danger bg-ink-bg-secondary px-4 py-2 text-center text-sm font-medium text-ink-danger"
    >
