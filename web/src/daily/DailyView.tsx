 ...
 * "TipTap 依存確認"). This is a functional, lumen-token-styled view
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="rounded-md border border-lumen-border px-2 py-1 text-sm text-lumen-text hover:bg-lumen-hover"
        >
          Today
        </button>
        <button
      ...
      <textarea
        ...
        className="w-full resize-y rounded-md border border-lumen-border bg-lumen-bg p-3 text-sm text-lumen-text"
      />
      ...
      {selectedDaily ? (
        <div className="space-y-2 rounded-md border border-lumen-border p-2">
          <div className="flex flex-wrap items-center gap-2">
      ...
      <section>
        <h2 className="mb-2 text-sm font-semibold text-lumen-text">
          ...
          {dailies.map((d) => (
            <li key={d.id}>
              <button
                ...
                className={`w-full rounded-md px-2 py-1 text-left text-sm hover:bg-lumen-hover ${
                  d.date === selectedDate
