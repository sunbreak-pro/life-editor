 ...
 * lumen-token-styled tree that exercises every shared tasks data path:
...
function StatusButton({
  ...
  return (
    <button
      ...
      className="w-4 shrink-0 text-lumen-text-secondary hover:text-lumen-accent"
    >
      {STATUS_GLYPH[status]}
    </button>
  );
    ...
    >
      ...
      <div className="flex items-center gap-1">
        ...
        <button
          ...
          className="shrink-0 cursor-grab text-lumen-text-secondary opacity-0 transition-opacity hover:text-lumen-text focus-visible:opacity-100 group-hover:opacity-100"
        >
        ...
        {isFolder ? (
          <button
            ...
            className="relative inline-flex h-[14px] w-[14px] shrink-0 items-center justify-center text-lumen-text-secondary hover:text-lumen-text"
          >
            <Folder
              size={14}
              aria-hidden
        ...
        <button
          ...
          className={
            isFolder
              ? "min-w-0 flex-1 truncate text-left font-medium text-lumen-text"
              : node.status === "DONE"
                ? "min-w-0 flex-1 truncate text-left text-lumen-text-secondary line-through"
                : "min-w-0 flex-1 truncate text-left text-lumen-text"
          }
        >
          {node.title || "(untitled)"}
        </button>
        ...
        <span className="flex shrink-0 items-center gap-0.5">
          <button
            ...
            title="Links"
            className={`rounded p-1 hover:bg-lumen-hover ${
              linkOpen
                ? "text-lumen-accent"
          ...
          {isFolder && (
            <button
              ...
              className="rounded p-1 text-lumen-text-secondary hover:bg-lumen-hover hover:text-lumen-accent"
            >
          ...
          <button
            ...
            aria-label="Delete"
            title="Delete"
            className="rounded p-1 text-lumen-text-secondary hover:bg-lumen-hover hover:text-lumen-danger"
          >
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex gap-2">
          <button
            ...
            className="rounded-md bg-lumen-accent px-3 py-1.5 text-sm text-lumen-on-accent hover:opacity-90"
          >
            + Task
          </button>
          <button
        ...
        <div className="flex gap-2 text-sm">
          <button
            ...
            onClick={tree.undo}
            className="text-lumen-text-secondary disabled:opacity-40"
          >
            Undo
          </button>
          <button
