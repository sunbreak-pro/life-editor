...
describe("the Materials task-list checkbox keeps its size (#1183 / #1368)", () => {
  ...
  it("stays visible in forced colours, in the user's own palette", () => {
    ...
    // The sheet holds more than one forced-colours block now (#1607 added one
    // for the link card's delete button), so pick THIS one by what it is about
    // rather than by it being the first.
