...
export function ScheduleScreen() {
  ...
  const handleToggleDayEventStatus = useCallback(
  ...
  const handleAddItem = useCallback(
    (input: {
      ...
      setGroups((prev) =>
        prev.map((g, gi) =>
          gi === 0 ? { ...g, items: [...g.items, newItem] } : g,
        ),
      );
    },
    [],
...
// =============================================
// Schedule Body (inner view container)
// =============================================
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex-1">
        ...
        {view === "list" && (
          <ListView groups={groups} onToggleStatus={onToggleStatus} />
        )}
      </div>
      ...
      <DayDetailSheet
        ...
        events={
          selectedDay
            ? (eventsByDate[dayKey(selectedDay.month, selectedDay.date)] ?? [])
            : []
        }
        onClose={closeSheet}
    ...
    <div className="px-3">
      ...
      >
        {days.map((d, i) => {
          ...
          const isToday =
            d.current && d.date === today && d.month === todayMonth;
...
function ThreeDayView() {
  ...
  const nowOffset =
    (NOW_HOUR - START_HOUR) * HOUR_HEIGHT + (NOW_MIN / 60) * HOUR_HEIGHT;
          ...
          {(
            ...
            return (
              ...
              >
                ...
                <span
                  className="text-sm"
                  style={{ color: on ? C.text : C.subtext0 }}
                >
                  {c.label}
                </span>
              </button>
