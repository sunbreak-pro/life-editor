...
export function MaterialsScreen() {
  ...
  const visible = notes
    ...
    .filter((n) =>
      filterNotebookId ? n.notebookId === filterNotebookId : true,
    )
    .filter((n) =>
...
function EmptyState({
  ...
  if (query)
    ...
    msg = kind === "notes" ? "まだノートがありません" : "まだ日記がありません";
  return (
      ...
      {notes.map((n) => (
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[11px] truncate" style={{ color: C.subtext0 }}>
              {n.excerpt || "本文がありません"}
            </div>
          </div>
          <div
      ...
      {notes.map((d) => (
        ...
        >
          ...
          >
            ...
            <span className="text-[9px] mt-0.5" style={{ color: C.subtext0 }}>
              {d.weekday}
            </span>
          </div>
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[10px] mt-1.5" style={{ color: C.overlay0 }}>
...
function ItemMenuSheet({
  ...
  return (
    <BottomSheet open={open} onClose={onClose} title={note?.title || "操作"}>
      <div className="space-y-0.5">
        <SheetRow
          icon={<Pin size={16} />}
