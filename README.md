...
- **ルーティン（ハビットトラッカー）**: 独立セクション、時間帯別グルーピング（朝/昼/夜/いつでも）、毎日/カスタム曜日/週N回の頻度設定、Grace Period（Don't Miss Twice）ストリーク計算、Habit Stacking（ルーティン連鎖）、GitHubスタイルヒートマップ、週次達成率チャート、マイルストーン祝福（7/30/100/365日）、At-Risk警告、タイマー連携（ルーティンからポモドーロ直接開始）
