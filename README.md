...
- **ルーティン（ハビットトラッカー）**: 独立セクション、タブ形式の時間帯ナビ（朝/昼/夜、カスタム時間帯設定可能）、ルーティンセット（横方向ステッパーUI、完了/次/未着手の3状態表示）、単体ルーティンリスト、毎日/カスタム曜日/週N回の頻度設定、Grace Period（Don't Miss Twice）ストリーク計算、GitHubスタイルヒートマップ、週次達成率チャート、マイルストーン祝福（7/30/100/365日）、At-Risk警告、タイマー連携（ルーティンからポモドーロ直接開始）
