...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Daily
            commands::daily_commands::db_daily_fetch_all,
            commands::daily_commands::db_daily_fetch_by_date,
            commands::daily_commands::db_daily_upsert,
            commands::daily_commands::db_daily_delete,
            commands::daily_commands::db_daily_fetch_deleted,
            commands::daily_commands::db_daily_restore,
            commands::daily_commands::db_daily_permanent_delete,
            commands::daily_commands::db_daily_toggle_pin,
            commands::daily_commands::db_daily_set_password,
            commands::daily_commands::db_daily_remove_password,
            commands::daily_commands::db_daily_verify_password,
            commands::daily_commands::db_daily_toggle_edit_lock,
            // Notes
            ...
            commands::note_link_commands::db_note_links_upsert_for_daily,
            ...
            commands::copy_commands::copy_daily_to_file,
