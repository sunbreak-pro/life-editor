...
- Issue #413 — Briefing の rightSidebar に Schedule の `TodayTodoTray`（#298）を流用配線し、残タスクを今日の候補へ配置可能に ✅（2026-07-27・**PR #422 open / merge 待ち**。wide 限定 = narrow に詳細パネルの開閉導線が無いため。実ブラウザ確認は merge 後 chat-main）
