...
- 🛑 **W3-C 前のユーザー作業**（2026-06-11 実測: storage.buckets 空 = バケット未作成）: Storage 公開バケット `sounds` 作成 + 音源 6 種（Rain/Thunder/Wind/Ocean/Birds/Fire）アップロード。ローカル `frontend/public/sounds/` に 5 種あり（rain.mp3 / wind.mp3 / sea_wave.mp3=ocean / bird_sea.mp3=birds / fire.mp3）— **thunder.mp3 のみ調達必要**。推奨オブジェクト名 = enum id（rain/thunder/wind/ocean/birds/fire.mp3）。DDL 前提（0018 6テーブル + realtime publication）は適用済み実測 = 残る前提はバケット + 音源のみ
