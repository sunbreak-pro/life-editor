...
- PR #417（#375 の QA 追随）merge 待ち。merge 後の実ブラウザ確認（Connect 凡例が note/daily/tag の 3 つ・Notes の Trash に幽霊 folder が出ないこと）は chat-main 側で
