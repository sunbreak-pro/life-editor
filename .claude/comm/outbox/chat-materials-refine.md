...
2026-09-01 dispatch の materials 残り 2 件を、それぞれ `origin/main` から独立に切って PR にしました（merge はこうだいさんの手番 = P-001）。両ブランチで CI verify のステップ列 14 本 + `docs-lint` をローカル実行して緑を確認済みです。
