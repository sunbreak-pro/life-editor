...
- **FileChanged 監視レイヤー** ([計画書](../docs/vision/plans/2026-05-23-filechanged-comm-watch.md)): `watch-comm.sh` が自分の Outbox (`chat-<name>.md`) を呼び鈴対象から除外する判定に使う
- **MEMORY/HISTORY per-chat 機構** ([計画書](../docs/vision/plans/2026-05-23-memory-history-per-chat-split.md)): task-tracker が `memory/chat-<name>.md` / `history/chat-<name>.md` の書き込み先を確定する
