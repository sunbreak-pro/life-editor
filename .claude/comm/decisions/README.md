...
- セッション開始時に ANSWERS.md を確認。自分宛の回答があれば、**まず `.claude/decisions/D-<id>.md` へ昇格**（キュー本文をそのまま貼って恒久保存 — 手順 = `.claude/decisions/README.md`・2026-08-09 D-20260809-main-1）してから、エントリを自分のファイルから削除して着手（ANSWERS.md 側の行は消さない — 監査ログを兼ねる）
