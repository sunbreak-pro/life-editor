...
- D-20260812-materials-2: **A**（#674 の残りはエラー文字列の書式を 3 種類のまま揃えず、重複している判定処理だけをまとめる = 挙動変更ゼロを維持。**キュー原文とは A/B のラベルが逆**なので中身で読むこと — 詳細は `decisions/D-20260812-materials-2.md`。同上）
