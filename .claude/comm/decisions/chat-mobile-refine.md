...
（回答済み 3 件は 2026-08-09 に `.claude/decisions/` 台帳へ昇格済み — D-20260730-mobile-1 / D-20260730-mobile-2 / D-20260730-mobile-3。2026-08-12 昇格分 = D-20260812-mobile-1。台帳化とキューからの除去は chat-main が代行した）
