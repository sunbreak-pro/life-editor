...
- **prettier の追い commit**: python で当てたパッチは PostToolUse の整形フックを通らないので、push 後の `prettier --check` で 7 ファイルが未整形だった。#1403 / #1440 / #1406 の 3 本に整形だけの commit を積んだ（挙動差ゼロ・CI は再走）
