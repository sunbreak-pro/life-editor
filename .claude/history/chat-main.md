...
### 2026-07-26 - chat-main 宿題消化（outbox 起票依頼 17 件 → #360〜#376・計画書所在の差し戻し）
...
- **計画書の差し戻し**: `2026-07-25-code-reduction.md` は origin/main・tracker ブランチ（#340/#343 merged）とも不在を実測 → COMPLETED 化・archive 移動は chat-main では不能。chat-code-reduction へ「訂正反映のうえ Status: COMPLETED で archive/ へ直接 commit → PR」を outbox で依頼
