...
- [`.claude/docs/vision/mobile-data-parity.md`](../mobile-data-parity.md) — Phase A/B 方針
- [`.claude/docs/vision/realtime-sync.md`](../realtime-sync.md) — 別セッションで作成された同期高速化案（untracked 段階）
