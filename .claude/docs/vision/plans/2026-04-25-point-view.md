...
> **デモ参照**: [`../../code-examples/PointGraphView.demo.jsx`](../../code-examples/PointGraphView.demo.jsx)（旧 `vision/PointGraphView.jsx`、2026-05-23 に code-examples/ へ移動）
> **作成日**: 2026-05-15
> **Status**: 機能計画書（cleanup-and-consolidation Phase 2-3 で vision/ から vision/plans/ へ rename）
...
デモ [`PointGraphView.demo.jsx`](../../code-examples/PointGraphView.demo.jsx) は単一ファイル ~1200 行。これを以下の責務で分割：
...
- デモ実装: [`../../code-examples/PointGraphView.demo.jsx`](../../code-examples/PointGraphView.demo.jsx)（artifact、2026-05-23 に vision/ → code-examples/ へ移動）
...
- デモ `PointGraphView.demo.jsx` (`docs/code-examples/`) の挙動を超える変更（例: 新フィルタ追加、レイアウト変更）は計画書外。別途要件確認すること
