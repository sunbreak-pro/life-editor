...
| D8  | アイテム行: 16px のチェックボックス枠（ホバー行 or 1 件以上選択中に表示）+ タイトル + 右端補助 + ホバーでシェブロン                                                                         | ボタン 1 個（クリック = 移動）                                          | `TagHubItemGroups.tsx`                                                                                                                       |
...
| #   | デザイン上の要素                                                                                                                                                                                  | 現行                                                        | 実装先                                                                                                              |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| M1  | 画面 1 上部バー: 左ハンバーガー（見た目 36・押せる面 44）/ 中央「つながり」/ 右「＋」（タグを追加）                                                                                               | 見出しなし                                                  | narrow の header（descriptor の narrow 行）+ 追加シート                                                             |
