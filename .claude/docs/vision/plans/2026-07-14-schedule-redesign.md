...
7. ✅ **Step 6: カレンダー台帳の配線（決定2）— 実装済み（2026-07-31・chat-schedule-refine / #468・PR #506 merged）** — グリッドにタグフィルタ（ツールバー下のカレンダーチップ）、CalendarView の i18n 化・ソフトデリート整合。**AC**: カレンダー選択で Week/Month の表示が絞り込まれる
