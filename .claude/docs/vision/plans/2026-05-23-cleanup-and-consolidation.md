---
Status: IN PROGRESS — Phase 1 進行中（1-1 / 1-2 / 1-4 / 1-5 完了 / 1-3 縮小適用済）
Created: 2026-05-23
Updated: 2026-05-23 (rebase origin/main 後の実態に合わせ Phase 1 スコープ調整 / 新 5 plan 反映)
...
Depends on: -
Next steps: Phase 1 commit + push → Phase 2 (vision/ ディレクトリ整理) 着手判断
---
