...
Status: Draft
Created: 2026-06-16
Branch: claude/web-app-shell-w5-79694z
Owner-chat: web-app-shell-w5
...
- [ ] `cd shared && npm run test`（vitest）全 pass（`MasterDetail` の最小 test 含む）
...
- [ ] PR diff が ±400 行以内（プリミティブ1部品 + パイロット1セクションの目安。scope creep ガード）
