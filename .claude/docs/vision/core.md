...
> **2026-08-30 追記の反転点**:
>
> - §2 Target User「作者本人（N=1）」の単独利用前提 → **限定人数（無料枠の安全圏 10〜20 人）への配布 + サインアップ開放へ転換**（2026-08-29 ユーザー裁定 = D-20260829-main-1。主ユーザーは作者のまま、ユーザー間のデータ分離は RLS owner-only。§1「チームコラボレーションを外す」は共有機能の話なので有効なまま）
>
