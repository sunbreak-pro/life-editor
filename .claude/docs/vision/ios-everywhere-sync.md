...
- 既知課題: `sync_last_synced_at` 未保存 / `tasks.updated_at` NULL on creation は 2026-04-20 に解消（V62 migration + sync_commands ガード、[known-issues/004](../known-issues/004-sync-last-synced-at-not-persisted.md) / [005](../known-issues/005-tasks-updated-at-null-on-creation.md)）
