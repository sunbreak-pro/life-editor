...
>
> 削除対象の最新リストは [`../docs/vision/plans/2026-05-23-cleanup-and-consolidation-deletion-targets.md`](./2026-05-23-cleanup-and-consolidation-deletion-targets.md) を参照（本ファイルは archive 移動済のためパスを修正）。
>
