...
Created: 2026-02-22
Drop reason: Based on Electron architecture (`electron/database/`, `electron/ipc/`). Superseded by Tauri 2.0 migration (2026-04-15). Parallel CodeReview (2026-04-18) 実施時に Blocking 3 / Important 5 を修正済みで、本 Plan の論点は Tauri 版には直接適用されない。3 ヶ月放置 (commit 1 件)。
---
