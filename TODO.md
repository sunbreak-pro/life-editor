...
- [x] AI Coaching (Feature D) — [archive/001-ai-coaching.md](.claude/archive/001-ai-coaching.md)
- [x] Noise Mixer 音声再生 — [archive/002-noise-mixer-audio.md](.claude/archive/002-noise-mixer-audio.md)
- [x] Polish & Enhancement — [archive/003-polish-enhancement.md](.claude/archive/003-polish-enhancement.md)
